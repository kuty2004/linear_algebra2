...
class TrainFaceData:
    ...
    def train(self):
        ...
        for class_dir in os.listdir(self.train_dir):
            ...
            test_paths = valid_img_paths[total_images - num_test:]
...
# with open('/Users/yewon/Desktop/q/model_n3.h5', 'rb') as f:
#     knn_clf = pickle.load(f) 

# KNN 모델 학습
train_data = TrainFaceData(train_dir, model_save_path="model_cleandata.h5", n_neighbors=None, knn_algo='ball_tree', verbose=False)
    ...
    if process_this_frame:
        ...
        for name in face_names:
            if name != "Unknown":
                ...
                elif elapsed_time >= 3:  # 3초 이상 인식된 경우
